...
同时也有研究 \cite{zhao2018federated, tuor2021overcoming, yoshida2019hybrid}表明，异质数据分布（即用户间数据分布不一致，non-independent identical distribution data, Non-IID）给FL的联合训练准确率带来了较大的挑战。
